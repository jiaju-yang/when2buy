...
flights_table = Table(
    ...
    Column('lowest_price_discount', Float, comment='最低价格折扣'),
    Column('cancellation_fee', Integer, comment='退票费'),
    Column('changing_seat_fee', Integer, comment='改舱费'),
    Column('cabin_class_code', String(1), comment='舱位级别代码：Y:经济舱；C:公务舱；F:头等舱'),
